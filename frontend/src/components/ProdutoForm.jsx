...
export default function ProdutoForm({ produto = {}, onSubmit, onCancel }) {
  ...
  function handlePictureChange(idx, value) {
    setForm((prev) => {
  ...
  function handleRemovePicture(idx) {
    setForm((prev) => {
      const pics = prev.pictures.filter((_, i) => i !== idx);
      return { ...prev, pictures: pics };
    });
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ fontFamily: 'Inter, Segoe UI, Roboto, Arial, sans-serif', background: '#fff', borderRadius: 12, boxShadow: '0 4px 24px #e5e7eb', padding: 24 }}>
      ...
      <Grid container columns={12} spacing={3}>
        ...
        <Grid gridColumn="span 12" style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
