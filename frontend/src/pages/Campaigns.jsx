...
export default function Campaigns() {
  ...
  const campaignColumns = [
    ...
    { 
      field: 'ctr', 
      label: 'CTR', 
      render: (_, item) => `${((item.clicks / (item.clicks * 10)) * 100).toFixed(2)}%`
    }
  ]
  ...
  const actions = [
    {
      label: 'Editar',
      onClick: (campaign) => console.log('Editar campanha:', campaign),
      className: 'bg-blue-100 text-blue-700 hover:bg-blue-200'
    },
    {
      label: 'Relatório',
      onClick: (campaign) => console.log('Ver relatório:', campaign),
      className: 'bg-green-100 text-green-700 hover:bg-green-200'
    },
    {
      label: 'Pausar',
      onClick: (campaign) => console.log('Pausar campanha:', campaign),
